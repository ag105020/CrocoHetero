...
def Croco(a,Step,Min,Max):
    ...
    B1=nan
    Normal0=genfromtxt('VchHighRes02.csv')
    #============================================================================
    for i in Urv:
        Dd=DdA[i]       #Changeable
...
Savefig('HeteroC00\\HighRes02',6)
Savetxt(Box_Vch/Normal,'HeteroC00\\HighRes02','03_Dd-Rn')
Savetxt(B1A,'HeteroC00\\HighRes02','03_B1A')
