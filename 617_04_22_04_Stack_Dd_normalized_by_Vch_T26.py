...
def Croco():
    ...
    if CreatingNormal == 1:
        ...
        ylabel('$C_S$/$C_S^0$')
        ylim(0,Ym)
        Savefig2('HeteroC00\\HighRes14','D0',300)
      ...
      #  ylim(0,Ym)
        xlabel(Xlab)
        ylabel('$C_S$/$C_S^0$')
        Savefig2('HeteroC00\\HighRes14','D1',300)
        
        figure(3)  #Plot in fmol C cell-1 d-1
        Conversion = 1e15*3600 #from molC cell-1 s-1 to fmol cell-1 day-1
        stackplot(DdA,CCHbiomass*Conversion,CCHN2fix*Conversion,CCHrespbiomass*Conversion,CCHrespN2fix*Conversion,CCHextraresp*Conversion,colors=StackPolotColors)
        ...
        xticks(Xticks)
        #xlim(0,1)
        Savefig2('HeteroC00\\HighRes14','D2',300)
