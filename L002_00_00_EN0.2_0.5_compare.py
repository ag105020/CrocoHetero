...
Savefolder = '02\\05 LightLimitationCroco\\EN=0.2 and 0.5'
Ylim = (0,150)
...
plot([],[],color='g',label='$\mathit{E_N}$ = 0.5')
plot([],[],color='b',label='$\mathit{E_N}$ = 0.2')
legend(loc=4)
#----------------
ylabel(Ylabel)
